...
async function main() {
  const path = resolve(process.cwd(), "lib/db/migrations/0016_orders_coupon_fields.sql");
  ...
  console.log("Applied 0016_orders_coupon_fields.sql (%d statements)", statements.length);
}
